...
public class MiniJava implements MiniJavaConstants {
  ...
  static final public TProgram Program() throws ParseException {
  TMainClass mc;
  TClassDeclList cdl;
    mc = MainClass();
    cdl = ClassDeclList();
  ...
  static final public TMainClass MainClass() throws ParseException {
  Token id1;
  Token id2;
  TStatement st;
  ...
  static final public TClassDeclList ClassDeclList() throws ParseException {
  TClassDecl cd;
  TClassDeclList cl;
  ...
  static final public TClassDecl ClassDecl() throws ParseException {
  Token id1;
  TIdentifier cde;
  TVarDeclList vdl;
  TMethodDeclList mdl;
  ...
  static final public TIdentifier ClassDeclExtends() throws ParseException {
  Token id1;
  ...
  static final public TVarDeclList VarDeclList() throws ParseException {
  TVarDecl vd;
  TVarDeclList vdl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
  ...
  static final public TVarDecl VarDecl() throws ParseException {
  TType ty;
  Token id1;
    ty = Type();
    id1 = jj_consume_token(ID);
  ...
  static final public TType Type() throws ParseException {
  Token id;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
  ...
  static final public TMethodDeclList MethodDeclList() throws ParseException {
  TMethodDecl md;
  TMethodDeclList mdl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PUBLIC:
  ...
  static final public TMethodDecl MethodDecl() throws ParseException {
  TType ty;
  Token id1;
  TFormalList fl;
  TExp e;
  ...
  static final public void VarDeclListMod(TVarDeclList vdl, TStatementList sl) throws ParseException {
  Token id1;
  Token id2;
  TExp e2;
  TExp e3;
  ...
  static final public TFormal Formal() throws ParseException {
  TType ty;
  Token id1;
    ty = Type();
    id1 = jj_consume_token(ID);
  ...
  static final public TFormalList FormalList() throws ParseException {
  TFormal f;
  TFormalList fl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
  ...
  static final public TFormalList FormalRest() throws ParseException {
  TFormal f;
  TFormalList fl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VIRGULA:
  ...
  static final public TStatementList StatementList() throws ParseException {
  TStatement s;
  TStatementList sl;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IF:
  ...
  static final public TStatement Statement() throws ParseException {
  int i = 0;
  TStatementList sl;
  TExp e1;
  TExp e2;
  ...
  static final public TExpList ExpList() throws ParseException {
  TExp e;
  TExpList el;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE:
  ...
  static final public TExpList ExpRest() throws ParseException {
  TExp e;
  TExpList el;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VIRGULA:
  ...
  static final public TExp Exp() throws ParseException {
  Token id1;
  TExp e1;
  TExp e2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public TExp ExpAux(TExp e1) throws ParseException {
  Token id2;
  TExp e2;
  TExpList el;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x600,0x80010000,0xc0000,0x0,0xc0000,0x800,0x0,0x0,0xc0000,0xc0000,0x0,0x80d00000,0x0,0x80d00000,0x3e000000,0x0,0x40000,0x3e000000,0x0,0x1000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x40000,0x2,0x40000,0x0,0x40002,0x40202,0x40000,0x40000,0x10,0x40000,0x202,0x40000,0xc0040,0x10,0x40000,0xc0040,0x1d80,0x40000,0x1d8a,};
   }
